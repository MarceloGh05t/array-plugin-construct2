...
(function ()
{
	...
	{
		if(y < this.cy && y >= 0){ //the condition will check if the u placed is less than the amount of element in the y axis, because the index starts with zero, and if the number is greater than zero to not place a negative value
		var x, z;
	...
	Acts.prototype.changePosition = function (from, to){
	let arr = this.arr;
