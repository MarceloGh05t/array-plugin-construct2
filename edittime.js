...
AddAnyTypeParam("Value", "The value to test if in the array.", "");
AddCondition(8,	0, "Contains value convert Lowercase", "Array", "Contains value convert Lowercase {0}", "Test if the array contains a value convert lowercase (at any element).", "ContainsConvertLowercase");

AddNumberParam("Y", "Y index (0-based) of array value to compare.", "0");
AddAnyTypeParam("Value", "Checks if the value exists in the chosen column y of the array.", "0");
AddCondition(9,	0, "Contains value column y ", "Array", " Y {0} Contains value {1}", "Test if the array contains a value in column specifies y.", "ContainsColumnY");
...
AddNumberParam("From", "The X index (0-based) of the array value from slice.", "0");
AddNumberParam("To", "The X index (0-based) of the array value to place.", "0");
AddAction(13, 0, "Change Position", "Manipulation", "Change element position x (index) from <i>{0}</i> to <i>{1}</i>.", "Change element position x.", "changePosition");
//////////////////////////////////////////////////////////////
// Expressions
...
AddNumberParam("X", "The X index (0-based) of the array.", "0");
AddAnyTypeParam("Value", "Value to search for.");
AddExpression(13, ef_return_number, "Index Y of", "Array", "IndexYOf", "Find first Y index in line specifies x of matching value, or -1 if not found.");
